...
class module1:
 def __init__(self, filePath1, dirPathOut):

    searchDir_input_data = filePath1 #sys.argv[1]     # ReadDir-training_data
    ...
    dataset = pd.read_csv(searchDir_input_data, encoding='SHIFT-JIS', index_col=0)  # SMILES 付きデータセットの読み込み
    ...
    savepath1 = os.path.join(saveDirName, 'CopolymerDescriptors_C.csv')
